...
const serviceUrl = 'http://localhost:3000/api/events';
...
class EventsTable extends Component {
  ...
  toolbarItemRender() {
    return (
      <Typography className="text-24">Events List</Typography>
    );
  }
    ...
    return (
      <Paper className="w-full">
        ...
        >
  				...
  				<StateStoring enabled={true} type="localStorage" storageKey="eventsTable" />
  				<Export enabled={true} fileName="Events" allowExportSelectedData={true} />
