...
const serviceUrl = 'http://localhost:3000/api/students';
...
class StudentsTable extends Component {
  ...
  toolbarItemRender() {
    return (
      <Typography className="text-24">Students List</Typography>
    );
  }
    ...
    return (
      <Paper className="w-full">
        ...
        >
  				...
  				<StateStoring enabled={true} type="localStorage" storageKey="studentsTable" />
  				<Export enabled={true} fileName="Students" allowExportSelectedData={true} />
