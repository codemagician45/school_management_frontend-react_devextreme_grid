...
const serviceUrl = 'http://localhost:3000/api/visitorinfo';
...
class Visitor extends Component {
  ...
  toolbarItemRender() {
    return (
      <Typography className="text-24">Visitor Information</Typography>
    );
  }
  ...
  render() {
    return (
      ...
      >
				...
				<StateStoring enabled={true} type="localStorage" storageKey="visitorinfoTable" />
				<Export enabled={true} fileName="Visitor Information" allowExportSelectedData={true} />
