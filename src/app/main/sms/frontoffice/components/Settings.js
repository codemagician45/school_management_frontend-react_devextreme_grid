...
const serviceUrl = 'http://localhost:3000/api/settings';
...
class Settings extends Component {
  ...
  toolbarItemRender() {
    return (
      <Typography className="text-24">Settings</Typography>
    );
  }
  ...
  render() {
    return (
      ...
      >
				...
				<StateStoring enabled={true} type="localStorage" storageKey="settingsTable" />
				<Export enabled={true} fileName="Settings" allowExportSelectedData={true} />
