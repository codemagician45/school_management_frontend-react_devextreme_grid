...
const serviceUrl = 'http://localhost:3000/api/complains';
...
class Complains extends Component {
  ...
  toolbarItemRender() {
    return (
      <Typography className="text-24">Complains</Typography>
    );
  }
  ...
  render() {
    return (
      ...
      >
				...
				<StateStoring enabled={true} type="localStorage" storageKey="complainsTable" />
				<Export enabled={true} fileName="Complains" allowExportSelectedData={true} />
